...
void main()
{
    ...
    Colour.r = clamp(Max-(Max-Colour.r)/Sat*(Sat+Position), -0.3, Max); // for red channel
    Colour.g = clamp(Max-(Max-Colour.g)/Sat*(Sat+Position), -0.3, Max); // for green channel
    Colour.b = clamp(Max-(Max-Colour.b)/Sat*(Sat+Position), -0.3, Max); // for blue channel
